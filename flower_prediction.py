...
#user input URL
url = raw_input("Provide an url of Flower for Prediction...")
if not os.path.isdir("test_data") :
    os.system("mkdir " + "test_data")
urllib.urlretrieve(url, "test_data/test_flower.jpg")

#Path where test data is stored
image_path = "test_data/test_flower.jpg"
features = []
...
if preds == 0:
    imagenet_class_name = "daisy"
elif preds == 2:
    imagenet_class_name = "rose"
elif preds == 3:
    imagenet_class_name = "sunflower"
elif preds == 4:
    imagenet_class_name = "tulip"
elif preds == 1:
    imagenet_class_name = "dandelion"

#Showing the picture
plt.imshow(img)
plt.text(45, 180, '%s Prediction: %s' % (model_name, imagenet_class_name), color='w', backgroundcolor='k', alpha=1)
